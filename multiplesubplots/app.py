...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Span("Scatter Plot x-axis", className="three columns",
                ...
                className="row"),
            html.Div([
                html.Span("Scatter Plot y-axis", className="three columns",
                          style={"width": 150, "padding": 10, "text-align": "right"}),
                ...
                className="row"),
            html.Div([
                html.Span("Bar Plot y-axis", className="three columns",
                          style={"width": 150, "padding": 10, "text-align": "right"}),
        ...
        html.Div([
            html.Div([
                html.Span("Box Plot x-axis", className="three columns",
            ...
            html.Div([
                html.Span("Box Plot y-axis", className="three columns",
                          style={"width": 150, "padding": 10, "text-align": "right"}),
        ...
        "layout": go.Layout(
            ...
            annotations=[
                ...
                },
                {
                    ...
                    "xref": "paper",
                    "yref": "paper",
                    "text": f'{text[selected_box_y].title()} vs '
                    f'{"Transmission" if selected_box_x == "am" else "Engine Type"}',
                    "showarrow": False,
                    "font": {
                        "size": 12
                    }
                },
                {
                    ...
                    "xref": "paper",
                    "yref": "paper",
                    "text": f'{text[selected_bar_y].title()} Vs Car Model',
                    "showarrow": False,
                    "font": {
                        "size": 15
                    }
            ...
            xaxis={
                "title": text[selected1].title(),
                "domain": [0, 0.40], "anchor": 'y',

            },
            yaxis={
                "title": text[selected2].title(),
            ...
            yaxis2={
                "title": text[selected_box_y].title(),
                "domain": [0.55, 1],
                "anchor": 'x2'
            },
            xaxis3={
            ...
            yaxis3={
                "title": text[selected_bar_y].title(),
