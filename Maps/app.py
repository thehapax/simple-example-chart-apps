...
app.layout = html.Div([
    html.Div([
        ...
        'textAlign': "center"}),
    html.Div([
        html.Span("Type of map", className="six columns",
                  style={'textAlign': "center", "display": "block", "text-decoration": "underline", "padding-top": 5}),
        dcc.Dropdown(id="map-type",
                     options=[
                         {'label': i, 'value': i} for i in map_list],
                     value='Scatter Plots on Mapbox', className="six columns")
    ], className="row",
        style={"display": "block", "margin-left": "auto", "margin-right": "auto", "width": "80%", "padding-top": 10}),
    html.Div([
...
def update_graph(type):
    ...
    layout2 = go.Layout(
        title="Statewide count of flights for February 2011",
        geo={
            "scope": 'usa',
    ...
    for i in range(len(limits)):
        ...
        layout4 = go.Layout(
            title=go.layout.Title(
                text='No of Flights For February 2011'
            ),
            showlegend=True,
            geo=go.layout.Geo(
                scope='usa',
    ...
    layout5 = go.Layout(
        title='Flight paths February 2011',
        geo=go.layout.Geo(
            scope="north america",
