...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Span("Type Of Chart : ")], className="six columns",
            style={"textAlign": "right", "padding-right": 30, "padding-top": 7}),
        html.Div([
            dcc.Dropdown(
                id='chart-type',
                options=[{'label': i, 'value': i} for i in charts],
...
def update_graph(chart):
    ...
    trace1 = [go.Scatter3d(
        ...
        mode="markers",
        marker={"opacity": 0.8, "color": "#4daf4a",
                "line": {"width": 0.5, "color": "#056B00"}})]

    layout1 = go.Layout(
        title="CO2 Emissions From Gaseous Fuel Consumption (% of total)",
        height=800,
        width=800,
        scene={
            "camera": {"eye": {"x": 1.3, "y": 1.3, "z": 1.3}},
            "aspectmode": "cube",
            "xaxis": {"title": "East Asia & Pacific"},
            "yaxis": {"title": "Europe & Central Asia"},
    ...
    trace2 = [go.Surface(
        x=df_1["Country Name"].unique(),
        y=df_1["Indicator Name"].unique(),
        z=df_1.iloc[0:, 3:].values,
    ...
    layout2 = go.Layout(
        ...
        width=1000,
        scene={
            "camera": {"eye": {"x": 1.45, "y": 1.45, "z": 1.45}},
            "aspectmode": "cube",
            "yaxis": {"tickangle": -30,
                      "tickmode": "array",
            ...
            "xaxis": {
                ...
                "ticktext": ['Afghanistan', 'Arab World', 'Australia', 'Belgium', 'Bangladesh',
                             'Brazil', 'Canada', 'Colombia', 'Germany', 'East Asia<br>& Pacific',
    ...
    list_country = ['East Asia & Pacific', 'Europe & Central Asia',
    ...
    for country, fill in zip(list_country, fill_color):
        ...
        trace3.append(go.Scatter3d(
            ...
            y=country_list * 2 + [country_list[0]],
            z=z_value + zeros + [z_value[0]],
            mode="lines",
            surfaceaxis=1,
            surfacecolor=fill,
            line={'color': fill, 'width': 4},
        ))
    layout3 = go.Layout(
        title="Electric power transmission and distribution losses per country",
        height=900,
        width=900,
        showlegend=False,
        scene={
            "camera": {"eye": {"x": 1.25, "y": -1.25, "z": .5},
            ...
            "yaxis": {
                ...
                "tickmode": "array",
                "tickfont": {"size": 11},
                "tickvals": list_country,
                "tickangle": 35,
                "ticktext": ['East Asia &<br>Pacific', 'Europe &<br>Central Asia',
            ...
            "zaxis": {
                "title": "Electric power transmission and<br>     distribution losses<br>       (% of output)",
                "tickfont": {"size": 10},
            },
    ...
    trace5 = [go.Streamtube(
        ...
        u=df['u'].values.tolist(),
        v=df['v'].values.tolist(),
        w=df['w'].values.tolist(),
        sizeref=0.5,
        colorscale='Viridis',
        cmin=0,
        cmax=3
