...
charts = ["Box Plot", "Error Bar", "Histogram", "2D Histogram", "Distplot", "Bullet Chart", "Scatterplot Matrix",
          "Violin Plot"]
    ...
    html.Div([
        ...
        html.Div([
            dcc.Dropdown(
                ...
                value="Distplots")], className="six columns"),
...
# TODO: violin(resident, purchase(M/F))
